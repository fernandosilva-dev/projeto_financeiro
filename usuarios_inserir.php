...
<div class="container">
  <center><h2>Inserir Usuário</h2></center>
  <!-- Inicia a tag FORM com as classes do Bootstrap -->
  <form method="post" action="usuarios_inserir_executar.php">  
    ...
    <div class="panel panel-default">
      ...
      <div class="panel-body">
        <div class="checkbox">
          ...
          <input type="checkbox" id="vConsultar" name="vConsultar">Consultar
          </label>
          <!-- Cria os controles de tela para o campo INSERIR -->
          <label class="checkbox-inline">
          <input type="checkbox" id="vInserir" name="vInserir">Inserir
          </label>
          <!-- Cria os controles de tela para o campo EDITAR -->
          <label class="checkbox-inline">
          <input type="checkbox" id="vEditar" name="vEditar">Editar
          </label>
          <!-- Cria os controles de tela para o campo EXCLUIR -->
          <label class="checkbox-inline">
          <input type="checkbox" id="vExcluir" name="vExcluir">Excluir
          </label>
        </div>
      </div>
    </div>    
