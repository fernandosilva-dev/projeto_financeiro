...
<div class="container">
  <center><h2>CADASTRO DE HISTÓRICOS</h2></center>
...
//Cria o botão INSERIR
    if (isset($_COOKIE[$vCookieInserir])and
       ...
       {
        $vOnClick="'historicos_inserir.php'";
...
echo '
    ...
    <div class="col-xs-6" style="text-align:right">
      <a target="_blank" class="btn btn-warning" href="historicos_relatorio.php">Imprimir Tabela</a>  
    </div>
  </div>
</div>
';
...
while($vTabela=mysqli_fetch_array($vExecucao)) 
     {
      ...
      if (isset($_COOKIE[$vCookieEditar])and
         ...
         {echo '<form method="post" action="historicos_editar.php">
      ...
      if (isset($_COOKIE[$vCookieExcluir])and
         ...
         {echo '<form method="post" action="historicos_excluir.php">
