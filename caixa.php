...
<div class="container">
  <center><h2>CADASTRO DE CAIXA</h2></center>
...
echo '
    ...
    <div class="col-xs-6" style="text-align:right">
      <a target="_blank" class="btn btn-warning" href="caixa_relatorio.php">Imprimir Tabela</a>  
    </div>
  </div>
</div>
';
?>
  ...
  <div class="container-fluid" style="padding-bottom:25px;">
    <!-- Filtro rápido -->
    <input type="text" id="vFiltro" onkeyup="Filtrar()" placeholder="Filtro rápido por data" title="Filtro rápido por data">
    <!-- Filtro avançado -->
    <a target="_blank" class="btn btn-info" href="caixa_filtrar.php">Filtro Avançado</a>
  </div>
    ...
    while($vTabela = mysqli_fetch_assoc($vExecucao)) 
         {
          ...
          $vSomaReceita = $vSomaReceita + $vTabela['receita'];
          $vSomaDespesa = $vSomaDespesa + $vTabela['despesa'];
          echo '<tr>
          ...
          if (isset($_COOKIE[$vCookieEditar])and
             ...
             {echo '<form method="post" action="caixa_editar.php">
          ...
          if (isset($_COOKIE[$vCookieExcluir])and
             ...
             {echo '<form method="post" action="caixa_excluir.php">
